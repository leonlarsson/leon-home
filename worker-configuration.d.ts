/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 70cdd1746029081924906ad7bc712302)
// Runtime types generated with workerd@1.20260114.0 2025-06-30 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		GUESTBOOK_EMAIL_DESTINATION: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SPOTIFY_ID" | "SPOTIFY_SECRET" | "SPOTIFY_REFRESH_TOKEN" | "GUESTBOOK_ADMIN_KEY" | "GUESTBOOK_EMAIL_DESTINATION" | "RESEND_API_KEY">> {}
}
