...
export default () => {
  return (
    <div className="select-none">
      {/* TOP HEADER */}
      <header className="relative z-50 mb-6 hidden px-6 min-[535px]:block">
        ...
        <div className="mx-auto mt-8 flex h-16 w-full max-w-5xl justify-between rounded-xl border-[1px] border-black/20 bg-white/50 px-2 dark:border-kinda-white/10 dark:bg-[#1e1e1e]/50">
          ...
          <div className="hidden items-center text-2xl min-[690px]:flex [&>*]:px-1">
      ...
      <header className="fixed inset-x-0 bottom-0 z-50 block px-6 pb-6 min-[535px]:hidden">
