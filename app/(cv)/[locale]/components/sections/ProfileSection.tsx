        ...
        <div className="flex flex-col gap-1">
          {data.url && (
            <Link
              href={data.url.href}
              target="_blank"
              className="flex w-fit items-center gap-2 font-geist-mono text-xs text-neutral-600 hover:underline"
            >
          ...
          {data.location && (
            <Link
              ...
              target="_blank"
              className="w-fit font-geist-mono text-xs text-neutral-600 hover:underline"
            >
