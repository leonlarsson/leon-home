  ...
  return (
    <div className="sf-top-first">
      <a href="/" style={{ marginBottom: 5 }}>
        <span style={{ fontSize: 30, fontWeight: 400 }}>Leon San José Larsson</span>
      </a>
      ...
      <a style={{ fontWeight: 300, marginBottom: 5 }} href="mailto:leonlarsson8@gmail.com" target="_blank">
      ...
      <Link style={{ fontWeight: 300 }} href={swedish ? "/sv/cv" : "/en/cv"} target="_blank">
